		...
		<form id="confirmEnrollment">
			...
			<div class="application">
					...
					<div id="short">
						<table>
							...
							<tr>
								...
								<td>:</td>
								<td><?php $sigOfDeptH1 = $studentRow["sigOfDeptHead1"]; ?>
						<img class="sigOfCandidate" src="candidateSignature/<?php echo $sigOfDeptH1; ?>"><br><br></td>
							</tr>
							<tr>
								<td>(C)Course Code</td>
								<td>:</td>
							...
							<tr>
								...
								<td>:</td>
								<<td><?php $sigOfDeptH2 = $studentRow["sigOfDeptHead2"]; ?>
						<img class="sigOfCandidate" src="candidateSignature/<?php echo $sigOfDeptH2; ?>"><br><br></td>
							</tr>
						</table>
					</div>
						<br><br>
						...
						<label>Signature of Dean:</label><?php $sigOfDean = $studentRow["sigOfDean"]; ?>
						<img class="sigOfCandidate" src="candidateSignature/<?php echo $sigOfDean; ?>"><br><br></td>
						<label>Signature of Exam controller:</label><?php $sigOfEC = $studentRow["sigOfExamController"]; ?>
						<img class="sigOfCandidate" src="candidateSignature/<?php echo $sigOfEC; ?>"><br>
					</div>
				...
				<div id="accountingManDiv">
					...
					<span>Signature of accounting manager : </span><?php $sigOfAm = $studentRow["sigOfAccountingManager"]; ?>
						<img class="sigOfCandidate" src="candidateSignature/<?php echo $sigOfAm; ?>">
